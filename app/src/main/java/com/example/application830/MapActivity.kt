...
class MapActivity : AppCompatActivity(), OnMapReadyCallback, GoogleMap.OnMarkerClickListener,
    ...
    private val checkPermission =
        registerForActivityResult(ActivityResultContracts.RequestMultiplePermissions()) { result ->
            result.forEach {
                if (!it.value) {
                    Toast.makeText(this@MapActivity, "갤러리를 열기 위해 권한 동의가 필요합니다.", Toast.LENGTH_LONG)
                        .show()
                    finish()
                }
            }
        ...
        map.setOnMapClickListener(object : GoogleMap.OnMapClickListener {
            override fun onMapClick(latLng: LatLng) {
                ...
                if (registerBtnClick) {
                    ...
                    val intent = Intent(this@MapActivity, MapaddressActivity::class.java)
                    ...
                    dig.setOnYesBtnClicked { content ->
                        Toast.makeText(this@MapActivity, "등록이 요청되었습니다.", Toast.LENGTH_LONG).show()
                        makeRegisterMarker(latLng)
                    }*/
                    //imageTrashCan = dig.dig.findViewById(R.id.imgTrashcan)

                    //imageTrashCan.setOnClickListener {
    ...
    override fun onMarkerClick(marker: Marker): Boolean {
        ...
        dig.setOnDeleteBtnClickedListener { content ->
    ...
    /*private val activityResult:ActivityResultLauncher<Intent> = registerForActivityResult(
        ...
        if(it.resultCode == RESULT_OK && it.data != null) {
            ...
            Glide.with(this).load(uri).into(binding.trashcanImg)
            imageTrashCan.setImageURI(uri)
        }
    }*/
}
